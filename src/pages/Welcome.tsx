...
const Welcome = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#ED213A] to-[#93291E]">
      <Marquee />
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col items-center">
          <div className="max-w-2xl w-full">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">La Ranchera Market</h1>
            <p className="py-4 text-lg md:text-xl text-yellow-400">Your authentic Mexican meat shop and restaurant, bringing the finest cuts and traditional flavors to your table.</p>
            
            <div className="flex flex-col md:flex-row gap-6 justify-center mt-8">
              {/* Hours Card */}
              <div className="stats bg-white bg-opacity-90 shadow hover:scale-105 transition-transform w-full md:w-auto">
                <div className="stat p-4">
                  <div className="stat-title text-gray-700 text-lg font-semibold mb-2">Business Hours</div>
              ...
              <div className="stats bg-white bg-opacity-90 shadow hover:scale-105 transition-transform w-full md:w-auto">
                <div className="stat p-4">
                  <div className="stat-title text-gray-700 text-lg font-semibold mb-2">Contact & Location</div>
                  <div className="flex flex-col gap-2">
                    <div className="text-gray-700">
                      <p className="font-medium">Phone</p>
                      <a href="tel:+1234567890" className="text-red-700 hover:text-red-800">(123) 456-7890</a>
                    </div>
                    <div className="text-gray-700">
                      <p className="font-medium">Address</p>
                      <p className="text-sm">123 Market Street</p>
                      <p className="text-sm">Nampa, ID 83686</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8">
              <a 
                href="/announcement" 
                className="btn btn-warning btn-lg text-white hover:bg-yellow-500 transition-colors w-full md:w-auto"
              >
