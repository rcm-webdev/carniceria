...
const Welcome = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#ED213A] to-[#93291E] relative">
      <Marquee />
      <div className="hero min-h-screen">
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            ...
            <h1 className="text-6xl font-bold text-white mb-4">La Ranchera Market</h1>
            <p className="py-4 text-xl text-yellow-400">Your authentic Mexican meat shop and restaurant, bringing the finest cuts and traditional flavors to your table.</p>
            
            <div className="flex gap-6 justify-center mt-8">
              {/* Hours Card */}
              <div className="stats bg-white bg-opacity-90 shadow hover:scale-105 transition-transform">
